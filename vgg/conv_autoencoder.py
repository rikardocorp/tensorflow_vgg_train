...
class CAEncoder:
    ...
    def get_conv_var(self, filter_size, in_channels, out_channels, name):
        ...
        # mm = 4 * np.sqrt(6. / (filter_size*filter_size*in_channels*out_channels))
        # initial_value = tf.truncated_normal([filter_size, filter_size, in_channels, out_channels], -mm, mm)
